...
export default function Davi() {
  return (
    <div className="page-davi">
      <h1>Davi Sousa Alves</h1>
      <img className="fotoDePerfil" src={daviFoto} alt="minha foto de perfil" />
      <nav>
        <ul>
          <li>
            <a href="https://www.instagram.com/daviiisousa19/" target="_blanck">
              <img className="instIcon" src={instagramIcon} alt="icone do insta" />
            </a>
          </li>
          <li>
