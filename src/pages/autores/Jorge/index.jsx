        ...
        <section className={styles.profileCard}>
            ...
            <div className={styles.profileInfo}>
                <div className={styles.infoSection}>
                    ...
                    <p className={styles.infoValue}>Jorge Eduardo Andrade Siqueira</p>
                </div>
                ...
                <div className={styles.infoSection}>
                    ...
                    <p className={styles.aboutText}>
                        Engenheiro Mecânico de formação. Analista de Sistemas na Teleceará (1978-1985) e no Banco do Nordeste (1986-2019). 
                        Atualmente estudando desenvolvimento FullStack na Digital School 💺
                    </p>
                </div>
